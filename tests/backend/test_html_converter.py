...
from backend.backend.docs_gen.html_converter import convert_html_to_docx
from tests._utils.test_utils import BaseTestCase, print_summary

class TestHtmlConverter(BaseTestCase):
    ...
    def test_basic_html_conversion(self):
        ...
        try:
            ...
            print(f"Error in test_basic_html_conversion: {str(e)}")
            import traceback
            traceback.print_exc()
    ...
    def test_complex_html_conversion(self):
        ...
        try:
            ...
            print(f"Error in test_complex_html_conversion: {str(e)}")
            import traceback
            traceback.print_exc()
